...
//      ?debug/?probe-гейты, телеметрия-зонды, z-index:99999);
...
const markers = [
  ...
  // 0.258: семейство URL-гейтов диагностики (?probe=drag из B-69 —
  // телеметрия жеста с выгрузкой лога; см. санитарную волну 0.258).
  // Ловим гейт, а не имя файла: «b69-log.json» легально упоминается
  // в историческом комментарии к фиксу 0.218.
  'probe=drag', 'probe=',
];
