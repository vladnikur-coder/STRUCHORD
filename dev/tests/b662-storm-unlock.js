...
ok(src.includes('function maybeUnlockPowerAchievementFromBpm')&&src.includes('bpm !== 220')&&src.includes('currentSongSeal !== LIGHTNING_SONG_SEAL'),'220 запускается только для подписанной Молнии с глобальным BPM 220');
