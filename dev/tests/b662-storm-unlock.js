...
ok(src.includes("@font-face")&&src.includes("./uploads/ofont.ru_Izhitsa.ttf")&&src.includes("font-family:'Izhitsa'")&&src.includes('thunder-title-etching')&&src.includes('Превью титра'),'старый широкий титр оставлен в dev-preview и использует локальный Izhitsa');
