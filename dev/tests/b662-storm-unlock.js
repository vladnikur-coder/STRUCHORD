...
ok(src.includes('thunder-plate-achievement')&&src.includes('thunder-plate-etching')&&src.includes('thunder-plate-mark')&&src.includes('thunder-plate-mark-bolt')&&src.includes('previewThunderPlateForDev')&&src.includes('Превью плашки'),'в dev добавлена компактная woodcut-плашка с видимой живой молнией для сравнения');
