...
//
// Запуск: NODE_PATH=/home/user/node_modules node dev/probe/golden-fixtures.js
...
fs.mkdirSync('/home/user/dev/fixtures', { recursive: true });
fs.writeFileSync('/home/user/dev/fixtures/rhythm-golden.json', JSON.stringify(golden, null, 1));
